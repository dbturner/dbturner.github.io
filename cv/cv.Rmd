...
CV <- create_CV_object(
  data_location = "https://docs.google.com/spreadsheets/d/1EHDt-Fe2jLw5Ki349wQRxk6snxO8_z83qSBywEiQdPA/edit#gid=1730172225",  
...
```{r}
cat("[<i class='fas fa-download'></i> Download a PDF of this CV](https://github.com/dbturner/dbturner.github.io/tree/master/cv)")
```
