---
title: "Daniel B. Turner's Resume"
...
CV <- create_CV_object(
  data_location = "https://docs.google.com/spreadsheets/d/1oqYu7eeIKErJ7el2XcTxBmYwjx-CSI6u0XPyWBzTCMw/edit?usp=sharing",  
...
```{r}
cat("[<i class='fas fa-download'></i> Full Curriculum Vitae here](https://dbturner.github.io/cv/cv.pdf)")
```
